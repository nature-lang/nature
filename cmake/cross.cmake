...
string(TOLOWER "${CMAKE_SYSTEM_PROCESSOR}" NATURE_SYSTEM_PROCESSOR)

if (NATURE_SYSTEM_PROCESSOR STREQUAL x86_64 OR
        NATURE_SYSTEM_PROCESSOR STREQUAL amd64)
    set(CMAKE_SYSTEM_PROCESSOR amd64)
    message("set CMAKE_SYSTEM_PROCESSOR=${CMAKE_SYSTEM_PROCESSOR}")
endif ()

if (NATURE_SYSTEM_PROCESSOR STREQUAL aarch64 OR
        NATURE_SYSTEM_PROCESSOR STREQUAL arm64)
    set(CMAKE_SYSTEM_PROCESSOR arm64)
    message("set CMAKE_SYSTEM_PROCESSOR=${CMAKE_SYSTEM_PROCESSOR}")
endif ()

unset(NATURE_SYSTEM_PROCESSOR)
...
elseif (CMAKE_SYSTEM_NAME MATCHES windows)
    message("add compile def __WINDOWS")
    add_compile_definitions(__WINDOWS=1)
else ()
