...
void amd64_reg_init() {
    ...
    rsi = reg_new("rsi", 6, REG_TYPE_INT, QWORD, 4);
    rdi = reg_new("rdi", 7, REG_TYPE_INT, QWORD, 5);
    r8 = reg_new("r8", 8, REG_TYPE_INT, QWORD, 6);
    r9 = reg_new("r9", 9, REG_TYPE_INT, QWORD, 7);
    r10 = reg_new("r10", 10, REG_TYPE_INT, QWORD, 8);
    r11 = reg_new("r11", 11, REG_TYPE_INT, QWORD, 9);
    r12 = reg_new("r12", 12, REG_TYPE_INT, QWORD, 10);
    r13 = reg_new("r13", 13, REG_TYPE_INT, QWORD, 11);
    r14 = reg_new("r14", 14, REG_TYPE_INT, QWORD, 12);
    r15 = reg_new("r15", 15, REG_TYPE_INT, QWORD, 13);
    ...
    xmm0 = reg_new("xmm0", 0, REG_TYPE_FLOAT, OWORD, 14);
    xmm1 = reg_new("xmm1", 1, REG_TYPE_FLOAT, OWORD, 15);
    xmm2 = reg_new("xmm2", 2, REG_TYPE_FLOAT, OWORD, 16);
    xmm3 = reg_new("xmm3", 3, REG_TYPE_FLOAT, OWORD, 17);
    xmm4 = reg_new("xmm4", 4, REG_TYPE_FLOAT, OWORD, 18);
    xmm5 = reg_new("xmm5", 5, REG_TYPE_FLOAT, OWORD, 19);
    xmm6 = reg_new("xmm6", 6, REG_TYPE_FLOAT, OWORD, 20);
    xmm7 = reg_new("xmm7", 7, REG_TYPE_FLOAT, OWORD, 21);
    xmm8 = reg_new("xmm8", 8, REG_TYPE_FLOAT, OWORD, 22);
    xmm9 = reg_new("xmm9", 9, REG_TYPE_FLOAT, OWORD, 23);
    xmm10 = reg_new("xmm10", 10, REG_TYPE_FLOAT, OWORD, 24);
    xmm11 = reg_new("xmm11", 11, REG_TYPE_FLOAT, OWORD, 25);
    xmm12 = reg_new("xmm12", 12, REG_TYPE_FLOAT, OWORD, 26);
    xmm13 = reg_new("xmm13", 13, REG_TYPE_FLOAT, OWORD, 27);
    xmm14 = reg_new("xmm14", 14, REG_TYPE_FLOAT, OWORD, 28);
    xmm15 = reg_new("xmm15", 15, REG_TYPE_FLOAT, OWORD, 29);
