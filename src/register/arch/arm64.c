...
void arm64_reg_init() {
    ...
    x16 = reg_new("x16", 16, LIR_FLAG_ALLOC_INT, QWORD, 17);
    x17 = reg_new("x17", 17, LIR_FLAG_ALLOC_INT, QWORD, 18);
    x18 = reg_new("x18", 18, LIR_FLAG_ALLOC_INT, QWORD, 0); // macos 保留
    x19 = reg_new("x19", 19, LIR_FLAG_ALLOC_INT, QWORD, 19);
    x20 = reg_new("x20", 20, LIR_FLAG_ALLOC_INT, QWORD, 20);
    x21 = reg_new("x21", 21, LIR_FLAG_ALLOC_INT, QWORD, 21);
    x22 = reg_new("x22", 22, LIR_FLAG_ALLOC_INT, QWORD, 22);
    x23 = reg_new("x23", 23, LIR_FLAG_ALLOC_INT, QWORD, 23);
    x24 = reg_new("x24", 24, LIR_FLAG_ALLOC_INT, QWORD, 24);
    x25 = reg_new("x25", 25, LIR_FLAG_ALLOC_INT, QWORD, 25);
    x26 = reg_new("x26", 26, LIR_FLAG_ALLOC_INT, QWORD, 26);
    x27 = reg_new("x27", 27, LIR_FLAG_ALLOC_INT, QWORD, 27);
    ...
    // 浮点寄存器
    v0 = reg_new("v0", 0, LIR_FLAG_ALLOC_FLOAT, QWORD, f_index + 1);
    v1 = reg_new("v1", 1, LIR_FLAG_ALLOC_FLOAT, QWORD, f_index + 2);
    v2 = reg_new("v2", 2, LIR_FLAG_ALLOC_FLOAT, QWORD, f_index + 3);
    v3 = reg_new("v3", 3, LIR_FLAG_ALLOC_FLOAT, QWORD, f_index + 4);
    v4 = reg_new("v4", 4, LIR_FLAG_ALLOC_FLOAT, QWORD, f_index + 5);
    v5 = reg_new("v5", 5, LIR_FLAG_ALLOC_FLOAT, QWORD, f_index + 6);
    v6 = reg_new("v6", 6, LIR_FLAG_ALLOC_FLOAT, QWORD, f_index + 7);
    v7 = reg_new("v7", 7, LIR_FLAG_ALLOC_FLOAT, QWORD, f_index + 8);
    v8 = reg_new("v8", 8, LIR_FLAG_ALLOC_FLOAT, QWORD, f_index + 9);
    v9 = reg_new("v9", 9, LIR_FLAG_ALLOC_FLOAT, QWORD, f_index + 10);
    v10 = reg_new("v10", 10, LIR_FLAG_ALLOC_FLOAT, QWORD, f_index + 11);
    v11 = reg_new("v11", 11, LIR_FLAG_ALLOC_FLOAT, QWORD, f_index + 12);
    v12 = reg_new("v12", 12, LIR_FLAG_ALLOC_FLOAT, QWORD, f_index + 13);
    v13 = reg_new("v13", 13, LIR_FLAG_ALLOC_FLOAT, QWORD, f_index + 14);
    v14 = reg_new("v14", 14, LIR_FLAG_ALLOC_FLOAT, QWORD, f_index + 15);
    v15 = reg_new("v15", 15, LIR_FLAG_ALLOC_FLOAT, QWORD, f_index + 16);
    v16 = reg_new("v16", 16, LIR_FLAG_ALLOC_FLOAT, QWORD, f_index + 17);
    v17 = reg_new("v17", 17, LIR_FLAG_ALLOC_FLOAT, QWORD, f_index + 18);
    v18 = reg_new("v18", 18, LIR_FLAG_ALLOC_FLOAT, QWORD, f_index + 19);
    v19 = reg_new("v19", 19, LIR_FLAG_ALLOC_FLOAT, QWORD, f_index + 20);
    v20 = reg_new("v20", 20, LIR_FLAG_ALLOC_FLOAT, QWORD, f_index + 21);
    v21 = reg_new("v21", 21, LIR_FLAG_ALLOC_FLOAT, QWORD, f_index + 22);
    v22 = reg_new("v22", 22, LIR_FLAG_ALLOC_FLOAT, QWORD, f_index + 23);
    v23 = reg_new("v23", 23, LIR_FLAG_ALLOC_FLOAT, QWORD, f_index + 24);
    v24 = reg_new("v24", 24, LIR_FLAG_ALLOC_FLOAT, QWORD, f_index + 25);
    v25 = reg_new("v25", 25, LIR_FLAG_ALLOC_FLOAT, QWORD, f_index + 26);
    v26 = reg_new("v26", 26, LIR_FLAG_ALLOC_FLOAT, QWORD, f_index + 27);
    v27 = reg_new("v27", 27, LIR_FLAG_ALLOC_FLOAT, QWORD, f_index + 28);
    v28 = reg_new("v28", 28, LIR_FLAG_ALLOC_FLOAT, QWORD, f_index + 29);
    v29 = reg_new("v29", 29, LIR_FLAG_ALLOC_FLOAT, QWORD, f_index + 30);
    v30 = reg_new("v30", 30, LIR_FLAG_ALLOC_FLOAT, QWORD, f_index + 31);
    v31 = reg_new("v31", 31, LIR_FLAG_ALLOC_FLOAT, QWORD, f_index + 32);
