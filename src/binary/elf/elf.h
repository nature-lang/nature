...
typedef struct
{
  ...
  Elf32_Addr	e_entry;		/* Entry pointer virtual address */
...
typedef struct
{
  ...
  Elf64_Addr	e_entry;		/* Entry pointer virtual address */
...
#define NT_MIPS_FP_MODE	0x801		/* MIPS floating-pointer mode.  */
...
/* Note section name of program key.   */
#define NOTE_GNU_PROPERTY_SECTION_NAME ".note.gnu.key"

/* Values used in GNU .note.gnu.key notes (NT_GNU_PROPERTY_TYPE_0).  */
...
#define OEX_FPDBUG	0x40000	/* Force floating pointer debug mode?  */
...
#define STT_PARISC_MILLICODE	13	/* Millicode function entry pointer.  */
...
#define SHF_ARM_ENTRYSECT	0x10000000 /* Section contains an entry pointer */
