...
string ast_stmt_expr_type_to_string[] = {
    [AST_EXPR_TYPE_LITERAL]="AST_EXPR_TYPE_LITERAL",
    [AST_EXPR_TYPE_BINARY]="AST_EXPR_TYPE_BINARY",
    [AST_EXPR_TYPE_UNARY]="AST_EXPR_TYPE_UNARY",
    [AST_EXPR_TYPE_IDENT]="AST_EXPR_TYPE_IDENT",
    [AST_EXPR_TYPE_ACCESS_STRUCT]="AST_EXPR_TYPE_ACCESS_STRUCT",
    [AST_EXPR_TYPE_ENV_INDEX]="AST_EXPR_TYPE_ENV_INDEX",
    [AST_EXPR_TYPE_ACCESS]="AST_EXPR_TYPE_ACCESS",
    [AST_EXPR_TYPE_SELECT]="AST_EXPR_TYPE_SELECT",
    [AST_EXPR_TYPE_ACCESS_MAP]="AST_EXPR_TYPE_ACCESS_MAP",
    [AST_EXPR_TYPE_NEW_MAP]="AST_EXPR_TYPE_NEW_MAP",
    [AST_EXPR_TYPE_ACCESS_LIST]="AST_EXPR_TYPE_ACCESS_LIST",
    [AST_EXPR_TYPE_NEW_LIST]="AST_EXPR_TYPE_NEW_LIST",
