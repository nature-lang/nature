...
typedef struct {
    ...
    Elf64_Half e_type;            /* Object file type */ // 文件类型 uint16_t
    Elf64_Half e_machine;        /* Architecture */ // 机器类型 uint16_t
    Elf64_Word e_version;        /* Object file version */ // 版本号 uint32_t
    Elf64_Addr e_entry;        /* Entry point virtual address */ // 程序入口点 uint64_t
    Elf64_Off e_phoff;        /* Program header table file offset */ // 程序头表文件偏移 uint64_t
...
typedef struct {
    ...
    // 符号值, 在 .o 文件中，该值记录符号相对于所在段基址的偏移量。仅符号的定义需要写入符号表,使用是不需要写入符号表的
    Elf64_Addr st_value;        /* Symbol value */
    Elf64_Xword st_size;        /* Symbol size */ // 符号表项
} Elf64_Sym;
...
typedef struct {
    ...
    // 重定位的类型和引用的符号, 高 24 位表示从定位符号对应的符号表项在符号表内的索引。
...
#define DF_1_NODEFLIB    0x00000800    /* Ignore default linux_amd64 search module_path.  */
...
#define EF_PPC_RELOCATABLE_LIB    0x00008000    /* PowerPC -mrelocatable-linux_amd64
						   flag */
...
#endif //NATURE_SRC_ASSEMBLER_ELF_LIB_ELF_H_
