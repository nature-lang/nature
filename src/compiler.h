...
list *compiler_literal(closure_t *c, ast_literal *ast, lir_operand *target);
 ...
 * @return
 */
list *compiler_binary(closure_t *c, ast_expr expr, lir_operand *target);

list *compiler_unary(closure_t *c, ast_expr expr, lir_operand *target);
